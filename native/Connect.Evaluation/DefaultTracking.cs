...
public static class DefaultTracking
{
    ...
    public static readonly (string Source,string Parameter,string Label,double Scale,bool Invert)[] Mappings = {
        ("faceYaw","ParamAngleX","顔・左右",15,true),("facePitch","ParamAngleY","顔・上下",15,true),("faceRoll","ParamAngleZ","顔・傾き",15,false),
        ("bodyYaw","ParamBodyAngleX","体・左右",8,true),("bodyPitch","ParamBodyAngleY","体・上下",8,false),
    ...
    public static string Create(JsonElement parameters)
    {
        ...
        return JsonSerializer.Serialize(new {format="standrig-tracking-profile",version=1,name="Connect standard",tracking=new {
